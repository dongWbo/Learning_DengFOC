...
void HMI::Form_Table_Updata(void) {
    ...
    lcd.ShowTextAlignRight(70, 55, lcd.Color.TextColor, lcd.Color.BackColor, lcd.FontSize_16, 0, 65, " %.2f",
                           (double)axes[0]->motor_.current_control_.Iq_measured * (double)axes[0]->motor_.config_.torque_constant * (double)axes[0]->motor_.config_.direction);
    // 当前电流Iq/Id
...
void HMI::Form_Table_Load() {
    ...
    // 绘制表框
    lcd.DrawLine(5, 55, 5, 135, lcd.Color.TableColor);
    //lcd.DrawLine(121, 48, 121, 128, lcd.Color.TableColor);
    lcd.DrawLine(235, 55, 235, 135, lcd.Color.TableColor);
    // 绘制箭头
    ...
    // 绘制表项
    lcd.ShowText(10, 55, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Tor. :");
...
void HMI::Form_Updata(void) {
    ...
    if (current_state_str_refresh_flag == true) {
        ...
        lcd.ShowText(10, 0, current_state_color, lcd.Color.BackColor, lcd.FontSize_32, 0, (const char *)"       ");
        lcd.ShowText(10 + (7 - strlen(line)) * 8, 0, current_state_color, lcd.Color.BackColor, lcd.FontSize_32, 0, line);
    }
    // 电压数据
    if ((double)vbus_voltage == 12.00 || (double)vbus_voltage < 5.0) {
        lcd.ShowText(178, 2, lcd.Color.ErrColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"NO-DC", (double)vbus_voltage);
    } else {
        lcd.ShowText(178, 2,
    ...
    switch (axes[0]->controller_.config_.control_mode) {
        case 0:
            lcd.ShowText(80, 35, lcd.Color.TextColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Vol.");
            break;
        case 1:
            lcd.ShowText(80, 35, lcd.Color.TextColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Tor.");
            break;
        case 2:
            lcd.ShowText(80, 35, lcd.Color.TextColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Vel.");
            break;
        case 3:
            lcd.ShowText(80, 35, lcd.Color.TextColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Pos.");
            break;
    }
    // 更新表格
...
void HMI::Form_Updata_Load() {
    // 绘制表头
    lcd.ShowText(10, 0, lcd.Color.NormColor, lcd.Color.BackColor, lcd.FontSize_32, 0, (const char *)"[     ]");
    lcd.ShowText(125, 2, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Vbus:");
    lcd.ShowText(226, 2, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"V");
    lcd.ShowText(125, 17, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Ibus:");
    lcd.ShowText(226, 17, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"A");
    lcd.ShowText(125, 32, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Tfet:");
    lcd.ShowText(226, 32, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"C");
    lcd.ShowText(10, 35, lcd.Color.TableColor, lcd.Color.BackColor, lcd.FontSize_16, 0, (const char *)"Mode : [     ]");
}
